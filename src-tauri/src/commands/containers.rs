...
#[tauri::command]
pub async fn get_container_stats(state: State<'_, AppState>, id: String) -> Result<crate::engine::types::ContainerStats, String> {
    state.engine.get_container_stats(&id).await
}

#[tauri::command]
pub async fn get_container_logs(state: State<'_, AppState>, id: String, tail: usize, timestamps: bool) -> Result<String, String> {
